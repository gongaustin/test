...
import com.gongjun.changsha.FuWuYeDos.dataSumJudgement;
...
//    private static String downLevel = "D:\\长沙项目\\科技\\地区";
    ...
    public static void dataJudge() {
        ...
        for (int i = 0; i < downExelList.size(); i++) {
            if (downExelList.get(i).getAbsolutePath().contains("高新") || downExelList.get(i).getAbsolutePath().contains("922-4"))
                downExelList.remove(i);
        }
        downExelList.forEach(e -> {
            System.out.println(e);
        });
