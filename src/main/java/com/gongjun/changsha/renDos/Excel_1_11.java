...
/**
 * @Description:处理表格922-1.xls中Sheet:"1-11",对应关系:1-11VS1-15A,1-16A（开放平台）
 * @Author: GongJun
 * @Date: Created in 10:35 2020/10/13
 */
public class Excel_1_11 {
    /**
     * @修改点******************************************************************
     */
    ...
    public static void todo() {
        ...
        String excelPathOne = receiveExcelPath("(1-15A)");
        String excelPathTwo = receiveExcelPath("(1-16A)");
        //获取两张表地区
    ...
    public static void dataWriteDos(List<String> bings, List<List<Object>> dataSheetDatas) {
         ...
         * @修改点******************************************************************
         * */
        Sheet standardSheet = standardWorkbook.getSheet("1-11");
        ...
        System.out.println("**********表格Excel_1_11处理完毕**********");
    }
