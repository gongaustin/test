...
/**
 * @Description:处理表格922-2.xls中Sheet:"2-19",对应关系:2-19VS2-24A,2-25A（开放平台）
 * @Author: GongJun
 * @Date: Created in 10:41 2020/10/13
 */
public class Excel_2_19 {
    /**
     * @修改点******************************************************************
     */
    ...
    public static void todo() {
        //按地区分组
        List<List<Object>> dataSheetDatas = excelDos("(2-24A)", Arrays.asList(0, 1, 2, 3, 4, 5, 6, 7, 8), Arrays.asList(1), 0);
        //按登记类型分组
        dataSheetDatas.addAll(excelDos("(2-25A)", Arrays.asList(0, 1, 2, 3, 4, 5, 6, 7, 8), Arrays.asList(1), 1));
...
//        List exceptCols = Arrays.asList(1);
    ...
    public static void dataWriteDos(List<List<Object>> dataSheetDatas) {
         ...
         * @修改点******************************************************************
         * */
        Sheet standardSheet = standardWorkbook.getSheet("2-19");
        ...
        System.out.println("**********表格Excel_2_19处理完毕**********");
    }
