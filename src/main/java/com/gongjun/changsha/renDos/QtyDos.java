...
import com.gongjun.changsha.synthesizeDos.newJudgement;
...
//                        log.info("区县数据转换错误:{},位置:{}--{}",e.getMessage(),zoneExcelFile,sheetName);
    ...
    public Map<String,List<Integer>> getQtyMap(){
        ...
        com.gongjun.changsha.interpriseDos.newJudgement  enew = new com.gongjun.changsha.interpriseDos.newJudgement();
