...
/**
 * @Description:处理表格922-2.xls中Sheet:"2-14",对应关系:2-14VS2-17A（开放平台）
 * @Author: GongJun
 * @Date: Created in 10:39 2020/10/13
 */
public class Excel_2_14 {
    ...
    public static void todo() {
        ...
        for (File f : fs) {                //遍历File[]数组
            if (!f.isDirectory())        //若非目录(即文件)，则打印
            {
                 ...
                 * @修改点******************************************************************
                 * */
                if (fileName != null && StringUtils.startsWithIgnoreCase(fileName, "(2-17A)") && StringUtils.endsWithIgnoreCase(fileName, ".xlsx"))
    ...
    public static void dataWriteDos(List<List<Object>> dataSheetDatas) {
         ...
         * @修改点******************************************************************
         * */
        Sheet standardSheet = standardWorkbook.getSheet("2-14");
        ...
        System.out.println("**********表格Excel_2_14处理完毕**********");
    }
