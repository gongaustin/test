...
public class Excel_2_06 {
    ...
    public static void todo() {
        ...
        String excelPathOne = receiveExcelPath("(2-06A)");
        String excelPathTwo = receiveExcelPath("(2-07A)");
        //获取两张表地区
        List<String> zonesOne = readZones(excelPathOne, 10);
        List<String> zonesTwo = readZones(excelPathTwo, 10);
        ...
        //读取数据
        List<List<Object>> dataOne = dataReadDos(excelPathOne, Arrays.asList(0, 1, 2, 5, 6, 7, 8, 9), deptsOne.size(), 2, 0);
    ...
    public static void dataWriteDos(List<String> bings, List<List<Object>> dataSheetDatas) {
         ...
         * @修改点******************************************************************
         * */
        Sheet standardSheet = standardWorkbook.getSheet("2-06");
