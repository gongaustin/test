...
/**
 * @Description:处理表格922-1.xls中Sheet:"2-05",对应关系:2-05VS2-05A（开放平台）
 * @Author: GongJun
 * @Date: Created in 10:38 2020/10/13
 */
public class Excel_2_05 {
    /**
     * @修改点******************************************************************
     */
    ...
    public static void todo() {
        ...
        for (File f : fs) {                //遍历File[]数组
            if (!f.isDirectory())        //若非目录(即文件)，则打印
            {
                 ...
                 * @修改点******************************************************************
                 * */
                if (fileName != null && StringUtils.startsWithIgnoreCase(fileName, "(2-05A)") && StringUtils.endsWithIgnoreCase(fileName, ".xlsx"))
    ...
    public static void dataWriteDos(List<String> bings, List<List<Object>> dataSheetDatas) {
         ...
         * @修改点******************************************************************
         * */
        Sheet standardSheet = standardWorkbook.getSheet("2-05");
