...
/**
 * @Description:处理表格922-2.xls中Sheet:"2-23",对应关系:2-23VS2-30A（开放平台）
 * @Author: GongJun
 * @Date: Created in 10:41 2020/10/13
 */
public class Excel_2_23 {
    ...
    public static void todo() {
        ...
        for (File f : fs) {                //遍历File[]数组
            if (!f.isDirectory())        //若非目录(即文件)，则打印
            {
                 ...
                 * @修改点******************************************************************
                 * */
                if (fileName != null && StringUtils.startsWithIgnoreCase(fileName, "(2-30A)") && StringUtils.endsWithIgnoreCase(fileName, ".xlsx"))
    ...
    public static void dataWriteDos(List<List<Object>> dataSheetDatas) {
         ...
         * @修改点******************************************************************
         * */
        Sheet standardSheet = standardWorkbook.getSheet("2-23");
        ...
        System.out.println("**********表格Excel_2_23处理完毕**********");
    }
