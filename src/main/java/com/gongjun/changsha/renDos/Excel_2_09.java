...
/**
 * @Description:处理表格922-2.xls中Sheet:"2-09",对应关系:2-09VS2-10A,2-11A（开放平台）
 * @Author: GongJun
 * @Date: Created in 10:38 2020/10/13
 */
public class Excel_2_09 {
    /**
     * @修改点******************************************************************
     */
...
//        List exceptCols = Arrays.asList(1);
    ...
    public static void dataWriteDos(List<List<Object>> dataSheetDatas) {
         ...
         * @修改点******************************************************************
         * */
        Sheet standardSheet = standardWorkbook.getSheet("2-09");
        ...
        System.out.println("**********表格Excel_2_09处理完毕**********");
    }
