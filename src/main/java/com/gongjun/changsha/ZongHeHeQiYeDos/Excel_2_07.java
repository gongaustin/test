...
/**
 * @Description:处理表格922-2.xls中Sheet:"2-07",对应关系:2-07VS2-08AA（开放平台）
 * @Author: GongJun
 * @Date: Created in 10:38 2020/10/13
 */
public class Excel_2_07 {
    ...
    public static void todo() {
        ...
        for (File f : fs) {                //遍历File[]数组
            if (!f.isDirectory())        //若非目录(即文件)，则打印
            {
                 ...
                 * @修改点******************************************************************
                 * */
                if (fileName != null && StringUtils.startsWithIgnoreCase(fileName, "(2-08AA)") && StringUtils.endsWithIgnoreCase(fileName, ".xlsx"))
    ...
    public static List<List<Object>> dataReadDos(String dataExcelPath) {
         ...
         * @修改点******************************************************************
         * */
        List exceptRows = Arrays.asList(0, 1, 2, 3, 4, 5, 6, 7);
        //dataSheet排除的列数(0开始，合并的列算一列)
        /**
         * @修改点******************************************************************
         * */
        List exceptCols = Arrays.asList(1, 8, 9, 10, 11, 23, 24, 25, 26, 27, 29, 30, 31, 32, 33);
    ...
    public static void dataWriteDos(List<List<Object>> dataSheetDatas) {
         ...
         * @修改点******************************************************************
         * */
        Sheet standardSheet = standardWorkbook.getSheet("2-07");
        ...
        System.out.println("**********表格Excel_2_07处理完毕**********");
    }
