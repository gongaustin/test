...
/**
 * @Description:处理表格922-1.xls中Sheet:"1-08",对应关系:1-08VS1-11A,1-12A（开放平台）
 * @Author: GongJun
 * @Date: Created in 10:35 2020/10/13
 */
public class Excel_1_08 {
    ...
    public static void todo() {
        ...
        String excelPathOne = receiveExcelPath("(1-11A)");
        String excelPathTwo = receiveExcelPath("(1-12A)");
        //获取两张表地区
    ...
    public static void dataWriteDos(List<String> bings, List<List<Object>> dataSheetDatas) {
         ...
         * @修改点******************************************************************
         * */
        Sheet standardSheet = standardWorkbook.getSheet("1-08");
        ...
        System.out.println("**********表格Excel_1_08处理完毕**********");
    }
