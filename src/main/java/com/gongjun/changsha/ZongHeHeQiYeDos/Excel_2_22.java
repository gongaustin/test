...
/**
 * @Description:处理表格922-2.xls中Sheet:"2-22",对应关系:2-22VS2-28A,2-29A（开放平台）
 * @Author: GongJun
 * @Date: Created in 10:41 2020/10/13
 */
public class Excel_2_22 {
    /**
     /**
     * @修改点******************************************************************
     */
...
//        List exceptCols = Arrays.asList(1);
    ...
    public static void dataWriteDos(List<List<Object>> dataSheetDatas) {
         ...
         * @修改点******************************************************************
         * */
        Sheet standardSheet = standardWorkbook.getSheet("2-22");
        ...
        System.out.println("**********表格Excel_2_22处理完毕**********");
    }
