...
/**
 * @Description:2018年XXX大类行业大中型
 * @Author: GongJun
 * @Date: Created in 10:10 2020/10/28
 */
public class Excel6_10 {
    ...
    public static void todo(String sourceExcelPath,String targetExcelPath){
        ...
        Sheet targetSheet = targetWorkbook.getSheet("6-10");
                ...
                if(dataTitle != null && dataTitle instanceof String){
                    if(title.equals(RegUtils.delAllSpaceForString((String)dataTitle))){
                        for (int j = 1; j < row.getPhysicalNumberOfCells(); j++) {
                            ...
                            if(value instanceof String && StringUtils.isNotBlank((String)value)) cell.setCellValue(Double.valueOf((String)value));
    ...
    @Test
    public void test(){
        todo("D:\\长沙项目\\工业\\地区\\芙蓉\\(6-10)2018年芙蓉区大类行业大中型.xlsx","D:\\长沙项目\\工业\\处理后\\地区\\芙蓉\\922-6.XLS");
    }
}
