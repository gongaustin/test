...
/**
 * @Description:2018年XXX大类行业私营
 * @Author: GongJun
 * @Date: Created in 10:10 2020/10/28
 */
public class Excel6_08 {
    ...
    public static void todo(String sourceExcelPath,String targetExcelPath){
        ...
        Sheet targetSheet = targetWorkbook.getSheet("6-08");
    ...
    @Test
    public void test(){
        todo("D:\\长沙项目\\工业\\地区\\芙蓉\\(6-08)2018年芙蓉区大类行业大中型.xlsx","D:\\长沙项目\\工业\\处理后\\地区\\芙蓉\\922-6.XLS");
    }
}
