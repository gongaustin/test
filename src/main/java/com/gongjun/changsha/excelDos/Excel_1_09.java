...
/**
 * @Description:处理表格922-1.xls中Sheet:"1-09",对应关系:1-09VS1-13A（开放平台）
 * @Author: GongJun
 * @Date: Created in 10:35 2020/10/13
 */
public class Excel_1_09 {
    ...
    public static void todo() {
        ...
        for (File f : fs) {                //遍历File[]数组
            if (!f.isDirectory())        //若非目录(即文件)，则打印
            {
                 ...
                 * @修改点******************************************************************
                 * */
                if (fileName != null && StringUtils.startsWithIgnoreCase(fileName, "(1-13A)") && StringUtils.endsWithIgnoreCase(fileName, ".xlsx"))
    ...
    public static void dataWriteDos(List<List<Object>> dataSheetDatas) {
         ...
         * @修改点******************************************************************
         * */
        Sheet standardSheet = standardWorkbook.getSheet("1-09");
        ...
        System.out.println("**********表格Excel_1_09处理完毕**********");
    }
