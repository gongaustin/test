...
public class Excel_4_02 {
    ...
    //标准表格Sheet关键字
    public static String keyword = "4-02";
    ...
    public static List<List<Object>> readDos() {
        ...
        List inCols = Arrays.asList(1, 72, 90, 93, 96);  //包含的列
            ...
            for (int j = 0; j < colNum; j++) {
                ...
                if (j == 1) {
                    if (value != null && value instanceof java.lang.String)
                        value = String.valueOf(value).trim().replaceAll("[　*| *| *|//s*]*", "").replaceAll("^[　*| *| *|//s*]*", "").replaceAll("[　*| *| *|//s*]*$", "");
                }
                rowData.add(value);
            }
